        ...
        stage('Deploy') {
                    steps {
                        timeout(time: 15, unit: 'MINUTES') {
                            retry(1) {
                                sh 'mkdir -p /opt/app/spring-boot-with-jenkins-sample/dev/'
                                sh 'mkdir -p /opt/app/spring-boot-with-jenkins-sample/test/'
                                sh 'mkdir -p /opt/app/spring-boot-with-jenkins-sample/uat/'
